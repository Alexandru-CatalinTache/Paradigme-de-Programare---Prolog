...
completare(integ(H, W, [], Vocab), [], integ(H1, W1, [], Vocab1)) :- false.
completare(integ(H, W, [((R, C), [(Text, Dir, ID)|Tail])|Lista], Vocab), [(Text_Intrebare, Text_Raspuns)|Tail], [((R, C), [(Text, Dir, ID)|Tail])|Lista]) :- false.
